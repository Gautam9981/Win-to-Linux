# Legacy BIOS (MBR) Version - Linux Distro Prep Script for Grub2Win
# Ubuntu / Fedora / Mint / Void / Arch / Debian Trixie
# Run as Administrator

# === Firmware Type ===
Write-Host "Firmware type detection is disabled."
Write-Host "This script supports Legacy BIOS (MBR) only."
$firmwareType = "Legacy"
...
$isoPartitionSizeGB = $isoSizeGB + 1  # buffer

Write-Host ""
$linuxSpaceGB = Read-Host "Enter extra space (GB) to leave for Linux installation (0 for none)"
