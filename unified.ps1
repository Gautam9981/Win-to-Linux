...
# This script creates a bootable partition that will enable you to enter the live environment of the distro without a USB, using Grub2Win (You will need to disable secure boot!!!)
